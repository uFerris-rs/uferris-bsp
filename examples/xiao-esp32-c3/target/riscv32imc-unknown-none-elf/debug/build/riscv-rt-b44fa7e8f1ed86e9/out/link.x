...
- In this linker script, you may find symbols that look like `${...}` (e.g., `32`).
...
ASSERT(ORIGIN(REGION_DATA) % 32 == 0, "
ERROR(riscv-rt): the start of the REGION_DATA must be 32-byte aligned");
